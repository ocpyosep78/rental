...
?></span></td>
  ...
  <tr bordercolor="#F0F0F0" bgcolor="#FFFFFF" >
    <td height="334" colspan="4" align="center" valign="top" bgcolor="#CCCCCC"><h3>Inqury Data Customer </h3>
...
<table border="1" cellpadding="5" cellspacing="0">
	<thead>
    	<tr>
        	...
        	<td class="style12">Kode Pelanggan</td>
        	<td class="style12">Nama Pelanggan</td>
			<td class="style12">Alamat</td>
			<td class="style12">Telepon</td>
			<td class="style12">Handpone</td>
        	<td class="style12">Email</td>
			<td class="style12">Person</td>
			<td class="style12">Npwp</td>
			<td class="style12">Salesman</td>
        	<td class="style12">Opsi</td>
        </tr>
    </thead>
    <tbody>
    <?php 
	...
	?>
    	<tr>
        	...
        	<td class="style12"><?php echo $data['nik']; ?></td>
        	<td class="style12"><?php echo $data['namacust']; ?></td>
			<td class="style12"><?php echo $data['alamat']; ?></td>
        	<td class="style12"><?php echo $data['telprumah']; ?></td>
        	<td class="style12"><?php echo $data['telphp']; ?></td>
			<td class="style12"><?php echo $data['email']; ?></td>
        	<td class="style12"><?php echo $data['person']; ?></td>
        	<td class="style12"><?php echo $data['npwp']; ?></td>
			<td class="style12"><?php echo $data['salesman']; ?></td>
        	<td class="style12">
