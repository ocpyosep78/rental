...
?></span></td>
  ...
  <tr bordercolor="#F0F0F0" bgcolor="#FFFFFF" >
    <td height="334" colspan="4" align="center" valign="top" bgcolor="#CCCCCC"><h3>Form Input Data Alat Berat </h3>
...
<table border="0" cellpadding="5" cellspacing="0">
    <tbody>
    	<tr>
        	...
        	<td>:</td>
        	<td><input type="text" name="kodealat" maxlength="20" required="required" /></td>
        </tr>
		<tr>
		...
		<tr>
        	<td>Type</td>
        	<td>:</td>
        	<td><input type="text" name="type" maxlength="20" required="required" /></td>
        </tr>
		<tr>
        	<td>Merk</td>
        	<td>:</td>
        	<td><input type="text" name="merk" maxlength="20" required="required" /></td>
        </tr>
		<tr>
        	<td>Tahun Beli</td>
        	<td>:</td>
        	<td><input type="text" name="tahunbeli" maxlength="20" required="required" /></td>
        </tr>
		<tr>
        	<td>Jumlah</td>
        	<td>:</td>
        	<td><input type="text" name="jumlah" maxlength="20" required="required" /></td>
        </tr>
		<tr>
        	<td>Harga Sewa</td>
        	<td>:</td>
        	<td><input type="text" name="hargasewa" maxlength="20" required="required" /></td>
        </tr>
		<tr>
