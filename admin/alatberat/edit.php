...
?></span></td>
  ...
  <tr bordercolor="#F0F0F0" bgcolor="#FFFFFF" >
    <td height="334" colspan="4" align="center" valign="top" bgcolor="#CCCCCC"><h3>Form Modify Data Alat Berat </h3>

      <?php 
$id = $_GET['id'];

$query = mysql_query("select * from talatberat where kodealat='$id'") or die(mysql_error());

$data = mysql_fetch_array($query);
?>

<form name="update_data" action="update.php" method="post">
<input type="hidden" name="kodealat" value="<?php echo $id; ?>" />
<table border="0" cellpadding="5" cellspacing="0">
    <tbody>
    	<tr>
        	<td>Kode Alat Berat </td>
        	<td>:</td>
        	<td><input name="kodealat" type="text" id="kodealat" value="<?php echo $data['kodealat']; ?>" size="30" maxlength="20" required="required" disabled /></td>
        </tr>
    	<tr>
        	<td>Nama Alat Berat</td>
        	<td>:</td>
        	<td><input name="namaalat" type="text" id="namaalat" value="<?php echo $data['namaalat']; ?>" size="30" maxlength="20" required="required" /></td>
        </tr>
		<tr>
        	<td>Type</td>
        	<td>:</td>
        	<td><input name="type" type="text" value="<?php echo $data['type']; ?>" size="30" maxlength="20" required="required" /></td>
        </tr>
		<tr>
        	<td>Merk</td>
        	<td>:</td>
        	<td><input name="merk" type="text" value="<?php echo $data['merk']; ?>" size="30" maxlength="20" required="required" /></td>
        </tr>
		<tr>
        	<td>Tahun Beli</td>
        	<td>:</td>
        	<td><input name="tahunbeli" type="text" id="tahunbeli" value="<?php echo $data['tahunbeli']; ?>" size="30" maxlength="20" required="required" /></td>
        </tr>
		<tr>
        	<td>Jumlah</td>
        	<td>:</td>
        	<td><input name="jumlah" type="text" id="jumlah" value="<?php echo $data['jumlah']; ?>" size="30" maxlength="20" required="required" /></td>
        </tr>
		<tr>
        	<td>Harga Sewa</td>
        	<td>:</td>
        	<td><input name="hargasewa" type="text" id="hargasewa" value="<?php echo $data['hargasewa']; ?>" size="30" maxlength="20" required="required" /></td>
        </tr>
