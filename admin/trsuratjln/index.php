...
?></span></td>
  ...
  <tr bordercolor="#F0F0F0" bgcolor="#FFFFFF" >
    <td height="334" colspan="4" align="center" valign="top" bgcolor="#CCCCCC"><h3>Form Input Surat Jalan Alat Berat </h3>
...
<table border="0" cellpadding="5" cellspacing="0">
    <tbody>
    	<tr>
        	...
        	<td>:</td>
        	<td><input type="text" name="kodesuratjln" maxlength="20" required="required" /></td>
        </tr>
		<tr>
        	<td>Tanggal surat jalan</td>
        	<td>:</td>
        	<td><input type="text" name="tglsuratjln" maxlength="50" required="required" /></td>
        </tr>
		<tr>
        	<td>Kode kontrak</td>
        	<td>:</td>
        	<td><input type="text" name="kodekontrak" maxlength="50" required="required" /></td>
        </tr>
		<tr>
        	<td>Kode operator</td>
        	<td>:</td>
        	<td><input type="text" name="kodeoperator" maxlength="50" required="required" /></td>
        </tr>
		<tr>
		...
		<tr>
        	...
        	<td>:</td>
        	<td><input type="text" name="alamatcust" maxlength="50" required="required" /></td>
        </tr>
		<tr>
        	<td>Telepon</td>
        	<td>:</td>
        	<td><input type="text" name="telp" maxlength="50" required="required" /></td>
        </tr>
		<tr>
        	<td>Penerima</td>
        	<td>:</td>
        	<td><input type="text" name="person" maxlength="50" required="required" /></td>
        </tr>
		<tr>
        	<td>Kode Alat Berat</td>
        	<td>:</td>
        	<td><input type="text" name="kodealat" maxlength="50" required="required" /></td>
        </tr>
		<tr>
		...
		<tr>
        	<td>QTY</td>
        	<td>:</td>
        	<td><input type="text" name="qty" maxlength="50" required="required" /></td>
        </tr>
		<tr>
