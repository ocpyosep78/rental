...
?></span></td>
  ...
  <tr bordercolor="#F0F0F0" bgcolor="#FFFFFF" >
    <td height="334" colspan="4" align="center" valign="top" bgcolor="#CCCCCC"><h3>Form Input Data Customer </h3>
...
<table border="0" cellpadding="5" cellspacing="0">
    <tbody>
    	<tr>
        	...
        	<td>:</td>
        	<td><input type="text" name="nik" maxlength="20" required="required" /></td>
        </tr>
		<tr>
		...
		<tr>
        	<td>Alamat</td>
        	<td>:</td>
        	<td><textarea name="alamat" cols="30" rows="3" id="alamat" required="required"></textarea></td>
        </tr>
		<tr>
        	<td>Telepon</td>
        	<td>:</td>
        	<td><input name="telprumah" type="text" id="telprumah" maxlength="20" required="required" /></td>
        </tr>
		<tr>
        	<td>Handpone</td>
        	<td>:</td>
        	<td><input name="telphp" type="text" id="telphp" maxlength="20" required="required" /></td>
        </tr>
		
		<tr>
        	<td>Email</td>
        	<td>:</td>
        	<td><input name="email" type="text" id="email" maxlength="20" required="required" /></td>
        </tr>
		<tr>
        	<td>Person</td>
        	<td>:</td>
        	<td><input name="person" type="text" id="person" maxlength="20" required="required" /></td>
        </tr>
		<tr>
        	<td>Npwp</td>
        	<td>:</td>
        	<td><input name="npwp" type="text" id="npwp" maxlength="20" required="required" /></td>
        </tr>
		<tr>
        	<td>Salesman</td>
        	<td>:</td>
        	<td><input name="salesman" type="text" id="salesman" maxlength="20" required="required" /></td>
        </tr>
		<tr>
