...
?></span></td>
  ...
  <tr bordercolor="#F0F0F0" bgcolor="#FFFFFF" >
    <td height="334" colspan="4" align="center" valign="top" bgcolor="#CCCCCC"><h3>Form Input Kwitansi Pembayaran Alat Berat </h3>
...
<table border="0" cellpadding="5" cellspacing="0">
    <tbody>
    	<tr>
        	<td>Kode Kwitansi </td>
        	<td>:</td>
        	<td><input type="text" name="kodekwitansi" maxlength="20" required="required" /></td>
        </tr>
		<tr>
        	<td>Tanggal Kwitansi</td>
        	<td>:</td>
        	<td><input type="text" name="tglkwitansi" maxlength="50" required="required" /></td>
        </tr>
		<tr>
        	<td>Pembayaran</td>
        	<td>:</td>
        	<td><input type="text" name="pembayaran" maxlength="50" required="required" /></td>
        </tr>
		<tr>
        	<td>Kode kontrak</td>
        	<td>:</td>
		...
		<tr>
        	<td>Jumlah bayar</td>
        	<td>:</td>
        	<td><input type="text" name="jumlahbayar" maxlength="50" required="required" /></td>
        </tr>
