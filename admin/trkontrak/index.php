...
?></span></td>
  ...
  <tr bordercolor="#F0F0F0" bgcolor="#FFFFFF" >
    <td height="334" colspan="4" align="center" valign="top" bgcolor="#CCCCCC"><h3>Form Input Kontrak Alat Berat </h3>
...
<table border="0" cellpadding="5" cellspacing="0">
    <tbody>
    	<tr>
        	<td>Kode Kontrak </td>
        	<td>:</td>
        	<td><input type="text" name="kodekontrak" maxlength="20" required="required" /></td>
        </tr>
		<tr>
        	<td>Tanggal kontrak</td>
        	<td>:</td>
        	<td><input type="text" name="tglkontrak" maxlength="50" required="required" /></td>
        </tr>
		<tr>
        	<td>Kode order</td>
        	<td>:</td>
