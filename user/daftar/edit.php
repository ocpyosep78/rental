...
?></span></td>
  ...
  <tr bordercolor="#F0F0F0" bgcolor="#FFFFFF" >
    <td height="334" colspan="4" align="center" valign="top" bgcolor="#CCCCCC"><h3>Form Modify Data Login </h3>

      <?php 
$id = $_GET['username'];

$query = mysql_query("select * from user where username='$id'") or die(mysql_error());
