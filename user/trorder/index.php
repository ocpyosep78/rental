...
?></span></td>
  ...
  <tr bordercolor="#F0F0F0" bgcolor="#FFFFFF" >
    <td height="334" colspan="4" align="center" valign="top" bgcolor="#CCCCCC"><h3>Form Input Pesan Alat Berat </h3>
...
<table border="0" cellpadding="5" cellspacing="0">
    <tbody>
		...
		<tr>
        	<td>Tanggal Order</td>
        	<td>:</td>
        	<td><input type="text" name="tglorder" maxlength="50" required="required" /></td>
        </tr>
		<tr>
		...
		<tr>
        	<td>Tanggal Sewa</td>
        	<td>:</td>
        	<td><input name="tglsewa" type="text" id="tglsewa" maxlength="20" required="required" /></td>
        </tr>
		<tr>
        	<td>Tanggal Kembali</td>
        	<td>:</td>
        	<td><input name="tglkembali" type="text" id="tglkembali" maxlength="20" required="required" /></td>
        </tr>
		
		<tr>
        	<td>Keterangan Lokasi</td>
        	<td>:</td>
        	<td><input name="ketlokasi" type="text" id="ketlokasi" maxlength="20" required="required" /></td>
        </tr>
